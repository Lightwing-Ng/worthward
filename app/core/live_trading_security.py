...
LIVE_TRADING_TOKEN_ENV = "WORTHWARD_LIVE_TRADING_TOKEN"
LEGACY_LIVE_TRADING_TOKEN_ENV = "ANTIGRAVITY_LIVE_TRADING_TOKEN"
LIVE_TRADING_TOKEN_HEADER = "X-Worthward-Live-Trading-Token"
LEGACY_LIVE_TRADING_TOKEN_HEADER = "X-Antigravity-Live-Trading-Token"
MIN_LIVE_TRADING_TOKEN_LENGTH = 32
LIVE_TRADING_PIN_ENV = "WORTHWARD_LIVE_TRADING_PIN"
LEGACY_LIVE_TRADING_PIN_ENV = "ANTIGRAVITY_LIVE_TRADING_PIN"
LIVE_TRADING_PIN_LENGTH = 6


def load_live_trading_access_token() -> str:
    return read_compatible_environment(LIVE_TRADING_TOKEN_ENV, LEGACY_LIVE_TRADING_TOKEN_ENV)


def resolve_live_trading_pin(configured_pin: object) -> str:
    environment_pin = read_compatible_environment(LIVE_TRADING_PIN_ENV, LEGACY_LIVE_TRADING_PIN_ENV)
    if environment_pin:
