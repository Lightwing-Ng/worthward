...
from app.core.preferences.broker import load_broker_settings
...
from app.services.analysis.presentation import format_display_date, format_display_datetime
from app.services.market.market_data import infer_ticker_market
