...
SHARED_STYLE_TOKEN_NAMES = (
    ...
    "--sidebar-toggle-top",
    "--sidebar-width",
    "--strategy-tune-button-icon-size",
    "--strategy-tune-button-size",
    "--strategy-tune-panel-blur",
    "--strategy-tune-panel-label-share",
    "--strategy-tune-panel-row-gap",
    "--strategy-tune-panel-row-height",
...
def build_style_token_rows(
    ...
    rows = [
        ...
        },
        {
            ...
            "sample_icon_shell_class": "",
            "tokens": [
                px_token("--secondary-button-min-height", 32, 1),
        ...
        },
        {
            ...
            "tokens": [
                ...
                px_token("--shared-select-option-min-height", 36, 1),
        ...
        {
            "id": style_token_id("Strategy tuning control"),
            ...
            "tokens": [
                material_reference_token("--strategy-tune-button-material", "Frosted glass"),
            ...
            "related_styles": [
                {
                    ...
                    "target_id": style_token_id("Circular icon button"),
                },
                {
                    "name": "Shared select filter",
                    "target_id": style_token_id("Shared select filter"),
        ...
        },
        {
            ...
            "sample_value": "2",
            "tokens": [
                raw_token("--workspace-metric-label-font-size", "var(--font-ui-lg)"),
                raw_token("--workspace-metric-label-line-height", "normal"),
                raw_token("--workspace-metric-label-letter-spacing", "normal"),
                raw_token("--workspace-metric-label-font-weight", "var(--font-weight-regular)"),
                raw_token("--workspace-metric-label-color", "var(--text)"),
                ...
                px_token("--workspace-metric-card-row-gap", 2, 0),
                raw_token("--workspace-metric-card-radius", "var(--radius-panel)"),
                px_token("--workspace-metric-card-label-min-height", 18, 1),
                px_token("--workspace-metric-card-min-height", 48, 1),
...
def build_font_token_rows(labels: Mapping[str, str]) -> list[dict[str, object]]:
    ...
    rows = [
        ...
        },
        {
            ...
            "samples": [
                {"token_name": "--field-title-font-size", "usage_label": "Field title", "sample_text": "Allocation  Period  Brokers", "sample_value": "15px"},
