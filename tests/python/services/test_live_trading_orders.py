...
class LongbridgeLiveTradingServiceTests(unittest.TestCase):
    ...
    def test_submit_longbridge_limit_order_matches_buy_example_from_docs(self) -> None:
        with patch(
            "app.services.investment.live_trading._load_longbridge_trade_api",
            return_value=(
                _FakeConfig,
                _FakeTradeContext,
    ...
    def test_legacy_account_readers_reject_missing_credentials_without_transport(self) -> None:
        ...
        with (
            patch("app.services.investment.live_trading._build_longbridge_trade_context") as mocked_sdk_context,
            patch("app.services.investment.live_trading.run_longbridge_cli_json") as mocked_cli_json,
        ):
    ...
    def test_load_longbridge_account_balances_uses_legacy_sdk_and_closes_context(self) -> None:
        ...
        with (
            patch(
                "app.services.investment.live_trading._build_longbridge_trade_context",
    ...
    def test_load_longbridge_account_balances_uses_cli_oauth_and_normalizes_items(self) -> None:
        ...
        with (
            patch("app.services.investment.live_trading.run_longbridge_cli_json", return_value=cli_payload) as mocked_cli_json,
            patch("app.services.investment.live_trading._build_longbridge_trade_context") as mocked_sdk_context,
        ):
