"""Research chronology, selection, and lifecycle contracts. Code version: v1.1.2."""
...
def test_explicit_research_group_keeps_original_default_and_rejects_ambiguous_ids():
    from strategies.price_field.neural.registry import FRONTIER_NEURAL_STRATEGY_IDS, LEGACY_NEURAL_STRATEGY_IDS
...
def test_frontier_mutations_stay_in_the_architecture_declared_small_sample_domain():
    from strategies.loader import instantiate_strategy
    from strategies.price_field.neural.registry import FRONTIER_NEURAL_STRATEGY_IDS, research_choices
...
def test_cpu_only_run_never_creates_gpu_work_and_freezes_before_reporting(tmp_path, monkeypatch):
    from strategies.price_field.neural.registry import FRONTIER_NEURAL_STRATEGY_IDS
