...
from app.core.preferences.date_display import DateDisplaySettings
from app.core.preferences.broker import BrokerSettings
from app.core.preferences.language import LanguageSettings
...
class ComparePageTests(unittest.TestCase):
    ...
    def test_ticker_comparison_market_cap_metric_accepts_ten_tickers_and_keeps_usd_new_york_base(self) -> None:
        ...
        with (
            ...
            patch("app.services.analysis.presentation.load_date_display_settings", return_value=date_display_settings),
        ):
