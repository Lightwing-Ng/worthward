"""Tests for standard table and shared-filter presentation contracts. Code version: v1.22.2."""
...
def test_allocation_badge_specimen_keeps_complete_numeric_values_until_shared_rendering() -> None:
    rows_source = (PROJECT_ROOT / "app/web/presentation/style_token_rows.py").read_text(
        encoding="utf-8"
    )
    template_source = (
