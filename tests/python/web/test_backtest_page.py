...
from app.core.preferences.language import LanguageSettings, translate_labels
    ...
    def test_every_enabled_strategy_starts_with_its_default_parameters(self) -> None:
        ...
        for strategy in list_enabled_strategies():
            ...
            with (
                ...
                patch(
                    "strategies.price_field.neural.strategy.NeuralPriceFieldStrategy.load_market_datasets",
                    return_value=[bayesian_dataset],
                ),
                patch(
