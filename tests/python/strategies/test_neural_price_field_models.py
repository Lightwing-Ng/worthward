...
from strategies.price_field.neural.compute import _make_model, walk_forward_neural_predictions
from strategies.price_field.neural.models import make_extended_model
...
def test_extended_core_imports_do_not_initialize_torch_or_web_application():
    result = subprocess.run([
        sys.executable, "-B", "-c",
        "import sys; import strategies.price_field.neural.models; "
...
def test_original_four_construction_never_delegates_to_extended_factory(torch_cpu, architecture):
    with patch("strategies.price_field.neural.models.make_extended_model", side_effect=AssertionError("legacy dispatch changed")):
