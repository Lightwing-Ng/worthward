"""Focused Shared select presentation contract tests. Code version: v1.0.7."""
...
STYLE_TOKEN_ROWS_PATH = PROJECT_ROOT / "app/web/style_token_rows.py"
...
def test_public_layout_contract_carries_complete_standard_select_semantics() -> None:
    ...
    assert "Documentation version: `v1.21.4`" in contract
