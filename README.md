...
- `Backtest`
  ...
  The long Bayesian contract immediately below is retained as historical release prose. The current implementation and scheduler version is v1.24.0, as stated in the amendment after that prose.
